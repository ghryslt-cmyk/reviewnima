...
const Layout = memo(({ children }) => {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-all duration-300 relative">
      ...
      <div className="fixed left-0 top-0 bottom-0 w-48 xl:w-56 z-10 hidden lg:block">
        <div 
      ...
      <div className="fixed right-0 top-0 bottom-0 w-48 xl:w-56 z-10 hidden lg:block">
        <div 
          className="w-full h-screen bg-cover bg-center"
          style={{ backgroundImage: "url('/full-img.png')" }}
        >
      ...
      <div className="flex max-w-[1600px] mx-auto relative z-20">
        ...
        <div className="hidden lg:block w-48 xl:w-56 flex-shrink-0"></div>
