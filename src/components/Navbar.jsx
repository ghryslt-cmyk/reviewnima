        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            {isAuthenticated ? (
              ...
              <Link
                to="/login"
                className="bg-black dark:bg-white text-white dark:text-black hover:bg-gray-800 dark:hover:bg-gray-200 px-3 sm:px-4 py-2 rounded-lg transition-all duration-300 font-medium hover:scale-105 border-2 border-black dark:border-white"
              >
                Login
              </Link>
            )}
