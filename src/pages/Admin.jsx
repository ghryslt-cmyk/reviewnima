      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-2 flex items-center">
            <Shield className="mr-3 text-purple-600" size={40} />
            Admin Panel
          </h1>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center">
            <Plus className="mr-2 text-purple-600" size={24} />
            Add New Review
          </h2>
          ...
          {!selectedAnime && (
            <form onSubmit={handleSearch} className="mb-6">
              ...
              {searchResults.length > 0 && (
                <div className="mt-4 border border-gray-200 dark:border-gray-700 rounded-lg max-h-96 overflow-y-auto">
                  {searchResults.map((anime) => (
                    <div
                      key={anime.id}
                      onClick={() => handleSelectAnime(anime)}
                      className="flex items-center p-4 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer border-b border-gray-200 dark:border-gray-700 last:border-b-0"
                    >
            ...
            <form onSubmit={handleSubmitReview}>
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  className="w-full p-4 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent resize-none"
                  rows="10"
                  required
                />
              </div>
              ...
              <button
                type="submit"
                disabled={submitting}
                className="flex items-center space-x-2 bg-purple-600 hover:bg-purple-700 disabled:bg-gray-400 text-white px-6 py-3 rounded-lg font-medium transition-colors"
              >
                {submitting ? (
                  <>
              ...
              {existingReviews.map((review) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="text-red-600 hover:text-red-700 px-4 py-2 rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors"
                  >
                    Delete
                  </button>
                </div>
