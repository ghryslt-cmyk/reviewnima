  ...
  return (
    <Layout>
      ...
      <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
        <div className="max-w-[1500px] mx-auto px-4 xs:px-6 sm:px-6 lg:px-8 py-4">
          <Link
            to="/news"
      ...
      {/* Main Content */}
      <div className="max-w-[1500px] mx-auto px-4 xs:px-6 sm:px-6 lg:px-8 py-8 xs:py-10 sm:py-12">
